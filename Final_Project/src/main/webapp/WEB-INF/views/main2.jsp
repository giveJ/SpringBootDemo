...
<!-- ------------------------상단바 시작---------------------------------- -->
   <div class="menu"> 
	   ...
	   <div class="middle_menu">
	      <ul class="middle_m">
	         <li><a href="#">Home</a></li>
	         <li><a href="#">돌봄</a></li>
	         <li><a href="${path}/product/list">용품</a></li>
	         <li><a href="#">클래스</a></li>
	         <li><a href="#">커뮤니티</a></li>
	         <li><a href="#">가족찾기</a></li>
	         <li class="dropdown">
	   ...
	   <div class="right_menu">
	 		 <ul class="right_m">
			      <li><a href="${path}/sample/customLogoutGet">로그아웃</a></li>
			      <li><a href="#">회원가입</a></li>   
			      <li><a href="${path}/product/cart"><img src="../resources/img/main2.png" width="37px" height="35px"></a></li>
	 		 </ul>  
	    </div>
 ...
 <!-- ------------------------내용 시작---------------------------------- -->
  ...
  <pre>돌봄서비스                                        반려동물 용품</pre> <br/>
            <img src="../resources/img/main7.jpg" width="650px" height="450px" >
            <img src="../resources/img/main6.jpg" width="650px" height="450px" > <br/>
   <pre>쿠킹클래스                                        가족찾기</pre>
      </div>
   ...
   <div class="dol">
      ...
      <a href="#"><img src="../resources/img/main7.jpg" width="700px" height="250px"></a>
      <br/>
      <br/>
      <br/>
      <br/>
