...
<head>
<meta charset="UTF-8">
<title>project_MODIFY_CLASS</title>
<style type="text/css">
...
<body>
	<div class="jss615">
		...
		<div class="jss616">
			<div class="jss617">
				<div class="jss624">
					<p class="MuiTypography-root MuiTypography-body1 jss637 css-1gflypb">클래스 생성</p>
				</div>
				<div class="MuiGrid-root MuiGrid-container MuiGrid-spacing-xs-4 jss618 css-1tz8m30">
					<div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12 MuiGrid-grid-md-4 jss640 css-19egsyp">
						<div class="MuiPaper-root MuiPaper-outlined MuiPaper-rounded jss641 css-1cy6rd">
							<div class="jss642">
								<svg class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium jss643 css-vubbuv" focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="AddIcon">
									<path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"></path>
								</svg>
								<p class="MuiTypography-root MuiTypography-body1 jss644 css-1gflypb">클래스 생성하기</p>
							</div>
						</div>
					</div>
				</div>
	...
	$(function() {
		$(".jss641").click(function() {
			location.href="/main/insert_class";
		});
		
		$(".jss630").click(function() {
			str=''
			str+='<div class="view">'
			str+='<table border="1">'
			str+='<tr style="width: 200px">'
			str+='<td rowspan="3">대표 이미지</td>'
			str+='</tr>'
			str+='<tr>'
			str+='<td>클래스 이름 : ${vo.class_name }</td>'
			str+='</tr>'
			str+='<tr>'
			str+='<td>클래스 가격 : ${vo.class_price }</td>'
			str+='</tr>'
			str+='</table>'
			str+='<div class="btn">'
			str+='<button class="modify_btn"> 클래스 관리</button>'
			str+='<button class="delete_btn"> 클래스 삭제</button>'
			str+='</div>'
			str+='</div>'
